...
source=("zen-browser-$realpkgver.tar.bz2::https://github.com/zen-browser/desktop/releases/download/$realpkgver/zen.linux.tar.bz2"
        "$_pkgname.sh"
        "$_pkgname.desktop"
        "policies.json")
sha256sums=('2252ff78d60f17862084c00c308aa51e23188562090adaa0d5628137ec8117bc'
